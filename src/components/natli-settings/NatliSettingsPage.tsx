...
function SettingCard({ item, onClick }: {
  ...
  return (
    <Card
      className="group relative flex flex-col p-5 hover:shadow-md hover:border-[#31D7DB]/50 transition-all cursor-pointer border-primary/20"
      onClick={onClick}
    >
      ...
      <div className="mt-4 pt-3 border-t border-primary/10">
        <span className="inline-flex items-center gap-1 text-xs font-medium text-lepos-cyan-text group-hover:text-[#28BDC1] transition-colors">
          Configure
      ...
      {restarting && (
        <Card className="border-[#31D7DB]/30 bg-gradient-to-r from-[#023F59]/5 to-[#31D7DB]/5">
          <div className="flex items-center justify-center gap-3 py-8">
            ...
            <span className="text-sm font-medium text-lepos-cyan-text">Server restarting...</span>
          </div>
        </Card>
      )}
        ...
        <div className="p-6 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="border-primary/20 text-lepos-cyan-text hover:bg-primary/5"
          ...
          <div className="space-y-5">
            <div className="space-y-1.5">
              ...
              <Select value={primary} onValueChange={setPrimary}>
                <SelectTrigger className="border-primary/20 focus:ring-[#31D7DB]/30">
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-foreground">Failover Model 1</label>
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-foreground">Failover Model 2</label>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-primary/10">
            ...
            <Button
              ...
              className="bg-primary hover:bg-[#022F44] text-white"
            >
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                ...
                <ul className="space-y-1 pl-2 border-l-2 border-[#31D7DB]">
                  <li>
                    ...
                    <span className="font-semibold text-lepos-cyan-text">{resolveLabel(primary) || '—'}</span>
                  </li>
                  <li>
                    <span className="text-foreground font-medium">Failover 1: </span>
                    <span className="font-semibold text-lepos-cyan-text">{fallback0 && fallback0 !== 'none' ? resolveLabel(fallback0) : '(none)'}</span>
                  </li>
                  <li>
                    <span className="text-foreground font-medium">Failover 2: </span>
      ...
      <Card className="border-primary/25 shadow-sm">
        <div className="flex flex-col items-center justify-center py-16 px-6 text-center space-y-4">
          ...
          <div className="rounded-full bg-primary/10 px-4 py-1.5">
            <span className="text-xs font-medium text-lepos-cyan-text">Coming Soon</span>
          </div>
        </div>
      </Card>
    </div>
    ...
    <div className="flex-1 space-y-4 min-w-0 w-full">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="bg-primary/5">
          ...
          <TabsTrigger value="core" className="data-[state=active]:bg-primary data-[state=active]:text-white">Core AI Setup</TabsTrigger>
          <TabsTrigger value="integration" className="data-[state=active]:bg-primary data-[state=active]:text-white">Integrations</TabsTrigger>
          <TabsTrigger value="security" className="data-[state=active]:bg-primary data-[state=active]:text-white">Security & Privacy</TabsTrigger>
        </TabsList>
