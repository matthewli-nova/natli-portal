...
export function SkillViewer({ skill }: SkillViewerProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* ── Metadata Bar ───────────────────────────────────────────── */}
      <div className="px-4 py-3 border-b border-primary/10 bg-primary/[0.02] flex flex-wrap gap-3 text-xs text-muted-foreground">
      ...
      {/* ── Tags ───────────────────────────────────────────────────── */}
      {skill.tags.length > 0 && (
        <div className="px-4 py-2 border-b border-primary/10 flex items-center gap-1.5 flex-wrap">
